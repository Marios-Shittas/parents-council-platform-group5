<?php
// Arxeio: app\views\pages\events.php
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo site_asset_url('css/user_css/events.css'); ?>">
...
<script src="<?php echo site_asset_url('js/event-open-modal.js'); ?>" defer></script>
</body>
</html>
