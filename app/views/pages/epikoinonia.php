...
<head>
    ...
    <link rel="stylesheet" href="<?php echo SiteContext::assetUrl('css/user_css/epikoinonia.css'); ?>">
</head>
<body>
    ...
    <script type="text/babel" src="<?php echo SiteContext::assetUrl('js/epikoinonia.jsx'); ?>"></script>
</body>
</html>
