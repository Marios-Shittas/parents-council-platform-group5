...
$footer_links = [
    ['label' => 'Αρχική', 'href' => SiteContext::sectionUrl('home.php')],
    ['label' => 'Σύνδεσμος Γονέων', 'href' => SiteContext::sectionUrl('parents.php')],
    ['label' => 'Ανακοινώσεις', 'href' => SiteContext::sectionUrl('announcements.php')],
    ['label' => 'Εκδηλώσεις', 'href' => SiteContext::sectionUrl('events.php')],
    ['label' => 'Χρήσιμες Πληροφορίες', 'href' => SiteContext::sectionUrl('useful-information.php')],
    ['label' => 'Αιτήσεις', 'href' => SiteContext::sectionUrl('applications.php')],
];

if (SiteContext::isParent()) {
    $footer_links[] = ['label' => 'Κατάστημα', 'href' => SiteContext::sectionUrl('eshop.php')];
    $footer_links[] = ['label' => 'Φωτογραφίες', 'href' => SiteContext::sectionUrl('photos.php')];
}

$footer_links[] = ['label' => 'Επικοινωνία', 'href' => SiteContext::sectionUrl('epikoinonia.php')];
?>
<link rel="stylesheet" href="<?php echo SiteContext::assetUrl('css/footer.css'); ?>">
