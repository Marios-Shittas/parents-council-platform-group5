    ...
    if ($action === 'toggle_shop_visibility') {
        ...
        if ($updated) {
            $_SESSION['flash_message'] = $isVisible
                ? 'Το κατάστημα είναι ξανά διαθέσιμο σε γονείς και public επισκέπτες.'
                : 'Το κατάστημα τέθηκε σε κατάσταση "Έρχεται Σύντομα" και έκλεισε για parent και public view.';
            $_SESSION['flash_message_type'] = 'success';
        } else {
                ...
                <div class="eshop-visibility-copy">
                    ...
                    <p>
                        <?php echo $isShopVisible
                            ? 'Οι γονείς και οι public επισκέπτες βλέπουν κανονικά τα προϊόντα και μπορούν να πραγματοποιήσουν αγορές.'
                            : 'Το κατάστημα κλείνει ταυτόχρονα για parent και public view και εμφανίζεται μόνο μήνυμα "Έρχεται Σύντομα".'; ?>
                    </p>
                </div>
