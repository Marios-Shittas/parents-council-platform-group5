...
$todayUiDate = getTodayUiDate();
$templatesClientData = array_map(static function ($t) use ($templateUiMeta, $todayUiDate) {
    ...
    return [
        ...
        'open_date' => (string)($templateMeta['open_date'] ?? $todayUiDate),
...
$templatesClientJson = json_encode($templatesClientData, JSON_UNESCAPED_UNICODE) ?: '[]';
?>
<!DOCTYPE html>
<html lang="el">
<head>
...
<script src="../assets/js/admin-applications-config.js" data-today-ui-date="<?php echo htmlspecialchars($todayUiDate, ENT_QUOTES, 'UTF-8'); ?>" data-templates-data="<?php echo htmlspecialchars($templatesClientJson, ENT_QUOTES, 'UTF-8'); ?>"></script>
