document.addEventListener('DOMContentLoaded', function () {
    var appConfig = window.adminApplicationsConfig || { todayUiDate: '', templatesData: [] };
    var todayUiDate = String(appConfig.todayUiDate || '');
    ...
    if (createModalEl) {
        createModalEl.addEventListener('hidden.bs.modal', function () {
            ...
            if (createApplicationOpenDate) {
                createApplicationOpenDate.value = todayUiDate;
            }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Template data (loaded from admin-applications-config.js)
    const templatesData = Array.isArray(appConfig.templatesData) ? appConfig.templatesData : [];
    ...
    if (templateSelector) {
        templateSelector.addEventListener('change', function() {
            ...
            if (editTemplateOpenDate) {
                editTemplateOpenDate.value = String(template.open_date || todayUiDate);
            }
            if (editTemplateCloseDate) {
    ...
    if (createTemplateForm) {
        ...
        createTemplateForm.addEventListener('reset', function () {
            createFormSchema = [];
            if (createTemplateOpenDate) {
                createTemplateOpenDate.value = todayUiDate;
            }
            if (createTemplateCloseDate) {
                createTemplateCloseDate.value = '';
            }
