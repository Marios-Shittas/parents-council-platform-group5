(function () {
    ...
    var usersBadgeText = (sidebar && sidebar.dataset && sidebar.dataset.usersBadge) || '';
    ...
    function updateToggleButton(isOpen) {
        var shouldShowToggle = isMobile() ? !wrapper.classList.contains('sidebar-open') : !isOpen;
    ...
    function isSidebarVisible() {
        return isMobile() ? wrapper.classList.contains('sidebar-open') : !wrapper.classList.contains('sidebar-collapsed');
    }
