...
(2, 'contact_info', 'Πληροφορίες Επικοινωνίας', 'Βρείτε τη διεύθυνση, τα τηλέφωνα, το email και το ωράριο της σχολικής μονάδας.', '{\"cards\":[{\"title\":\"Διεύθυνση\",\"text\":\"ΑΡΓΟΛΙΔΟΣ 45, 4007 ΜΕΣΑ ΓΕΙΤΟΝΙΑ, Λεμεσός\",\"icon\":\"fas fa-map-marker-alt\",\"link_label\":\"\",\"link_url\":\"\"},{\"title\":\"Τηλέφωνο\",\"text\":\"Τηλέφωνο: 25694570\\nΤηλεομοιότυπο: 25694575\",\"icon\":\"fas fa-phone\",\"link_label\":\"\",\"link_url\":\"\"},{\"title\":\"Email\",\"text\":\"\",\"icon\":\"fas fa-envelope\",\"link_label\":\"dim-mesa-geitonia29-lem@schools.ac.cy\",\"link_url\":\"mailto:dim-mesa-geitonia29-lem@schools.ac.cy\"},{\"title\":\"Ώρες Λειτουργίας\",\"text\":\"Δευ-Παρ - 7.30-13.05\",\"icon\":\"fas fa-clock\",\"link_label\":\"\",\"link_url\":\"\"}]}', '2026-04-11 19:03:11'),
...
(10, 'statute_section', 'Καταστατικό Συνδέσμου', 'Αρχεία διαθέσιμα μόνο για συνδεδεμένους γονείς.', '{\"eyebrow\":\"Έγγραφα Συνδέσμου\",\"open_label\":\"Άνοιγμα PDF\",\"empty_message\":\"Δεν έχει προστεθεί ακόμη καταστατικό.\",\"statutes\":[]}', '2026-04-29 00:00:00');
...
(1, 'page_header', 'Χρήσιμοι Πληροφορίες & Σύνδεσμοι', 'Χρήσιμοι σύνδεσμοι και πληροφορίες,ενημερωτικό υλικό,έντυπα και ενημερώσεις.', '{\"eyebrow\":\"Οδηγός Γονέων Και Μαθητών\"}', '2026-04-11 19:03:11'),
